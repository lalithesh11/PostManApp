...
function getElementFromString(string) {
  ...
  //   return div;
  return div.firstElementChild; // inside created div, the firstElementChild is the html what we are passing through string.
}

// Initialize no of parameters
let addedParamCount = 0;

// Hide the parameters box initially, beacuse Content Type was Json initially
let parametersBox = document.getElementById("parametersBox");
parametersBox.style.display = "none";

// if the user selects Content type as Custom Parameters, hide the Json Box
...
// if the user selects Content type as Json, hide the params Box
...
submit.addEventListener("click", () => {
  ...
  // If user has used parameters option instead of json, collect all the parameters in an object
